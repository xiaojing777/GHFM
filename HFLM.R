...
func_fuse_logistic_lasso = function(x.fd, y, beta.basis, b0, lam, phi, intercept = FALSE, clustering=FALSE, x.penalty=FALSE, KK=0, label=NULL, max.iteration=30, tol=0.95){
